...
@Table(name = "stat_house_qm_partner_quarterly_stat")
public class StatHouseQmPartnerQuarterlyStat implements IDynamicTableName {
    @Id
    private Integer id;
