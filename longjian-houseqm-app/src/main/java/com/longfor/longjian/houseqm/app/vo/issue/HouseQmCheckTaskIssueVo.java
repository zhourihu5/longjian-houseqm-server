 ...
 * @Package: com.longfor.longjian.houseqm.app.vo.issue
 * @ClassName: HouseQmCheckTaskIssueVo
 * @Description: java类作用描述
 * @Author: hy
 * @CreateDate: 2019/1/11 18:10
 */
@Data
@NoArgsConstructor
public class HouseQmCheckTaskIssueVo implements Serializable {
    private Integer id;
     ...
     * 其它数据
     */
    private HouseQmCheckTaskIssueDetail detail;
}
