...
public class AppHouseqmStatisticController {
     ...
     * @Param [request, req]
     **/
    @GetMapping(value = "project_list/", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @Param [request, req]
     **/
    @GetMapping(value = "project_issue_stat/", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @Param [request, req]
     **/
    @GetMapping(value = "project_checker_stat/", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
