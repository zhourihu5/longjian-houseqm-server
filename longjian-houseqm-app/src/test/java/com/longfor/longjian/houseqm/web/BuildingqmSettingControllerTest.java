...
public class BuildingqmSettingControllerTest {
    ...
    public void testTaskList() throws Exception {
        mockMvc.perform(
                post("/setting/v3/papi/buildingqm/get_issuefiled_setting").header("token",TOKEN)
                        .param("project_ids","930").param("category_cls","23")
