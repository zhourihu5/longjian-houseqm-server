...
import com.longfor.longjian.houseqm.domain.internalService.impl.CategoryV3ServiceImpl;
...
public class CategoryV3ServiceImplTest {

    @Resource
    private CategoryV3ServiceImpl categoryV3ServiceImpl;

    @Test
    public void searchCategoryV3ByKeyInAndNoDeleted() {
        try{
